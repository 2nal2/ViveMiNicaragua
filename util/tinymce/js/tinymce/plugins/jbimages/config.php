...
// LOCAL HOST
	$config['img_path'] = '/ViveMiNicaragua/uploads'; // Relative to domain name
	$config['upload_path'] = '/opt/lampp/htdocs'.$config['img_path'];

  // HOSTING
  // $config['img_path'] = '/uploads'; // Relative to domain name
  // $config['upload_path'] = '/home/vol5_4/wwhost.ga/wwhtg_18060721/htdocs/'.$config['img_path'];
