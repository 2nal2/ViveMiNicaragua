...
<?php
  ...
  include_once '../Controller/Usuario/update_user_admin.php';
 ?>
 <br>
 <br>
 <form class='panel1' name="form_image" enctype="multipart/form-data" action="../change-foto-admin.php" method="post">
