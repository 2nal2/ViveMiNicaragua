    ...
    <div class="mensajePrincipal roboto">
        ...
        <div id="inicios">
            <?php if(!isset($_SESSION['id_user'])): ?>
              <a data-fancybox-type="iframe" href="usuario/singup.php" class="fancybox" id="registrate">Regístrate</a>
            <?php endif; ?>
